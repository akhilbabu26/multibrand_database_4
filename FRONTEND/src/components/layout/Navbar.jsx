        ...
        <div className="ml-auto flex items-center gap-1 sm:gap-2">
          ...
          {isCustomer && (
            <>
              <Link
                to="/wishlist"
                className={`relative flex h-10 w-10 items-center justify-center rounded-xl transition hover:bg-slate-100 dark:hover:bg-slate-800 ${
          ...
          {isCustomer ? (
            <div className="relative pl-1" ref={profileRef}>
              <button
                ...
                className="flex items-center gap-2 rounded-xl py-1.5 pl-1 pr-2 transition hover:bg-slate-100 dark:hover:bg-slate-800"
              ...
              >
                {avatarUrl ? (
                  ...
                  <div className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-indigo-500 to-violet-600 text-xs font-bold text-white ring-2 ring-slate-200 dark:ring-slate-700">
                    {initials}
                  </div>
                )}
                <span className="hidden max-w-[7rem] truncate text-sm font-medium text-slate-800 dark:text-slate-200 sm:block">
                  {displayName}
                </span>
                <ChevronDown
              ...
              {profileOpen && (
                <div
                  role="menu"
                  className="absolute right-0 mt-2 w-52 origin-top-right rounded-xl border border-slate-200 bg-white py-1 shadow-xl shadow-slate-900/10 dark:border-slate-700 dark:bg-slate-900"
                >
                  <Link
                    role="menuitem"
                    to="/orders"
                  ...
                  <button
                    ...
                    className="flex w-full items-center gap-2 px-4 py-2.5 text-sm text-rose-600 transition hover:bg-rose-50 dark:text-rose-400 dark:hover:bg-rose-950/30 disabled:opacity-50 disabled:cursor-not-allowed"
