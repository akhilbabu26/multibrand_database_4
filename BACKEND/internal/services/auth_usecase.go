...
func (u *authUsecase) Signup(ctx context.Context, name, email_, password, cPassword string) error {
...
func (u *authUsecase) VerifyOTP(ctx context.Context, email_, otp string) error {
...
func (u *authUsecase) Login(ctx context.Context, email_, password string) (string, string, error) {
...
func (u *authUsecase) Logout(ctx context.Context, userID uint, accessToken string) error {
...
func (u *authUsecase) ForgotPassword(ctx context.Context, email_ string) error {
	user, err := u.repo.FindByEmail(email_)
	if err != nil {
		return nil
	}
...
func (u *authUsecase) ResetPassword(ctx context.Context, email_, otp, newPassword, confirmPassword string) error {
